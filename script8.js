function desconto(){
    ...
    mensagem.innerHTML = "<h2>Calculando o desconto de 10% para " + produto + "</h2>"+"O preço original era de R$ " + precooriginal + "<br> Você acaba de ganhar R$" + desconto.toFixed(2) + " de desconto (-10%).<br>No fim você vai pagar R$" + preconovo.toFixed(2) + " no produto " + produto 
